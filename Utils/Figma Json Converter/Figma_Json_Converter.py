...
def convert_node(figma_node, offset_x, offset_y, is_root=False):
    ...
    if figma_node.get("type") == "TEXT":
        ...
        node_data["topLeftRadius"] = figma_node.get("topLeftRadius", figma_node.get("cornerRadius", 0))
        node_data["topRightRadius"] = figma_node.get("topRightRadius", figma_node.get("cornerRadius", 0))
        node_data["bottomLeftRadius"] = figma_node.get("bottomLeftRadius", figma_node.get("cornerRadius", 0))
        node_data["bottomRightRadius"] = figma_node.get("bottomRightRadius", figma_node.get("cornerRadius", 0))
