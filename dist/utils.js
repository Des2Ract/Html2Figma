...
export function mergeStyles(styles1, styles2) {
    return Object.assign(Object.assign({}, styles1), styles2);
}
...
export function formatStyles(styles) {
    ...
    for (const key in styles) {
        if (styles.hasOwnProperty(key)) {
            const formattedKey = key.replace(/-([a-z])/g, (match) => match[1].toUpperCase()); // Convert to camelCase
