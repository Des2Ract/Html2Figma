...
def load_model_and_encoders():
    ...
    try:
        ...
        checkpoint = torch.load("tag_classifier_complete.pth", map_location=torch.device('cpu'))
        ...
        model.load_state_dict(torch.load("best_tag_classifier.pth", map_location=torch.device('cpu')))
